        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="../../index.html">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center"><img src="{{ asset('icons/logo.png') }}" alt="phoenix"
                            width="27" />
                        <h5 class="logo-text ms-2 d-none d-sm-block">LMS</h5>
                    </div>
                </div>
            </a>
        </div>
        <ul class="navbar-nav navbar-nav-icons flex-row">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img class="rounded-circle"
                                                    src="{{ asset('team/40x40/58.webp') }}" alt="">
                                            </div>
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="{{ asset('team/40x40/57.webp') }}" alt="">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
                    ...
                    <div class="card position-relative border-0">
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    <img class="rounded-circle " src="{{ asset('team/72x72/57.webp') }}"
                                        alt="">
                        ...
                        <div class="card-footer p-0 border-top border-translucent">
                            <div class="px-3 my-2"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                                    href="#!">
