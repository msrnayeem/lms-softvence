                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-errors"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown-indicator-icon-wrapper"><span
                                    ...
                                    class="nav-link-text">Course</span>
                            </div>
                        </a>
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse"
                                id="nv-errors">
                                <li class="collapsed-nav-item-title d-none">Create Course
                                </li>
                                <li class="nav-item"><a class="nav-link active" href="">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Create Course</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
